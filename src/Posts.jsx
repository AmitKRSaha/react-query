...
export function Posts() {
  ...
  // For prefetching next  thats curr + 1 request data
  ...
  const { data, isError, error, isLoading } = useQuery(
    ['posts', currentPage], // Currentpage now is dependent if it changes it gonna refetch
    () => fetchPosts(currentPage),
    {
      staleTime: 2000,
      keepPreviousData: true, // For holding data in cache
    });
